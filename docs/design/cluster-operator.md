...
- [ ] CRD definition and code generation
- [ ] Controller scaffolding with kubebuilder
- [ ] Leader election setup
- [ ] Basic reconcile loop structure
- [ ] Unit tests with mocks

### Phase 2: Health Monitoring
- [ ] Node health checking (NotReady detection)
- [ ] etcd health checking via Talos API
- [ ] Status updates in CRD
- [ ] Metrics and events

### Phase 3: Worker Replacement
- [ ] Cordon and drain logic
- [ ] Hetzner server deletion
- [ ] New server creation
- [ ] Talos config application
- [ ] Integration tests

### Phase 4: Control Plane Replacement
- [ ] etcd member removal
- [ ] Quorum verification
- [ ] CP server replacement
- [ ] etcd rejoin verification
...
### Phase 6: E2E Testing
- [ ] Kill worker, verify replacement
- [ ] Kill CP (HA), verify replacement
...
4. **Upgrade orchestration**: Should operator handle Talos/K8s version upgrades?
